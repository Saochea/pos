...
const ListUsers = () => {
  ...
  // get users
  const { data } = useQuery(['listUsers', keyword, limit], fetchUsers);
  //console.log(data);
  ...
  return (
    <div className="h-screen overflow-auto bg-gray-100 flex-1">
      ...
      <div className="p-5">
                      ...
                      <td className="p-3 whitespace-nowrap">
                        {user.username !== auth.username ? (
                          <>
                            ...
                            <button
                              className="px-3 py-1.5 ml-2 rounded-sm font-medium tracking-wider text-white bg-green-500 hover:shadow"
                              onClick={() => {
                          ...
                          <>
                            <button
                              className="px-3 py-1.5 mr-2 rounded-sm font-medium tracking-wider text-blue-300 bg-gray-100"
                              disabled
                              onClick={() => {
                                setId('');
                              }}>
                            ...
                            <button
                              className="px-3 py-1.5 mr-2 rounded-sm font-medium tracking-wider text-red-300 bg-gray-100"
                              disabled
                              onClick={() => {
                                setId('');
                              }}>
                            ...
                            <button
                              className="px-3 py-1.5 rounded-sm font-medium tracking-wider text-gray-300 bg-gray-100"
                              disabled
                              onClick={() => {
                                setId('');
                              }}>
        ...
        <p className="my-3 text-xs text-gray-500">{`ជួរដេកសរុប : ${data && data.totalRows
          } ទំព័រ: ${data && data.totalRows ? data && data.page : 1} នែ ${data && data.totalPage
          }`}</p>
        <nav
          role="navigation"
